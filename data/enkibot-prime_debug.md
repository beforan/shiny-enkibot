...
* [BLU+RDM] You can Confuse an Enchanted Fan to learn White Wind, which you really should since it's rad. This tip does not apply on Pixel on PC specifically, where it's bugged to require !Control.
...
* ...but they'll revive each other, so you need to stun them, use some other all-target option, or time your turns REALLY well.
* The easiest way to do this fight is to summon Odin from the Magic Lamp for a triple kill.
* You can recharge the Magic Lamp in the spring two screens back from here (in the single-width indentation on the bottom-right of the water, one left from the door) before leaving.
* [BRD] Requiem is, as you might expect, completely disgusting here. Still probably slower than Odin.
* [WHM] Don't forget that White Mages can spam target-all Curagas on them.
* [WHM] Or hit each one exactly once with a single-target Curaga, then finish them all off at once with a multi-target one.
* [BER] If you're going to fight it out, you probably want to kill your Berserker.
...
* [DNC] And don't forget the Man-Eater, because it's better than everything else a Dancer can wield that isn't the Chicken Knife.
...
* [DRG+DNC] Despite its sprite, the Man-Eater deals double damage with !Jump like a spear. Except on Pixel, where it doesn't... for some reason. Just be aware.
* [FRE+DNC] Despite its sprite, the Man-Eater deals double damage with !Jump like a spear. Except on Pixel, where it doesn't... for some reason. Just be aware.
...
* [DRG] The Dragon Lance is super-effective against the Grand Cross part, if you stole one (please do not waste the effort just for this.)
* [DRG] Almagest is telegraphed by Neo Exdeath beginning to shake, and Grand Cross is telegraphed by the warning 'The laws of the universe mean nothing!'. A well-timed !Jump can dodge those.
...
* [ORC] You can land Condemn on the back piece to kill it via Doom. (That's the one that dies to Magic Lamp Odin anyway.) But if you wanted something to do with your Oracle, there you go.
